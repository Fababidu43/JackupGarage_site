  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <div className="section section--entretien py-4 sm:py-6 lg:py-8 slide-in-left diagonal-cut-top-backslash" style={{ background: 'linear-gradient(135deg, #0A0A0A 0%, #1A1A1A 100%)' }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
              <div>
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg flex items-center justify-center mb-3 sm:mb-4" style={{ background: '#FF6B35', color: 'white' }}>
                  <Droplets className="w-8 h-8 sm:w-10 sm:h-10" />
                </div>
                
                <h3 className="text-lg xs:text-xl sm:text-2xl lg:text-3xl font-black mb-2 sm:mb-3 tracking-tight leading-tight uppercase text-white font-futuristic">
                  Entretiens
                </h3>
                ...
                <button 
                  ...
                  className="inline-flex items-center font-semibold text-sm sm:text-base group uppercase tracking-wide text-orange-400 hover:text-orange-300 font-tech transition-colors min-h-[44px]"
                >
                  Demander un devis
        ...
        <div className="section py-4 sm:py-6 lg:py-8 slide-in-right diagonal-cut-top-slash diagonal-cut-bottom-backslash" style={{ background: 'linear-gradient(135deg, #F8F9FA 0%, #FFFFFF 100%)' }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
              <div className="lg:order-2">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg flex items-center justify-center text-white mb-3 sm:mb-4" style={{ background: '#FF6B35' }}>
                  <Zap className="w-8 h-8 sm:w-10 sm:h-10" />
                </div>
                
                <h3 className="text-lg xs:text-xl sm:text-2xl lg:text-3xl font-black mb-2 sm:mb-3 tracking-tight leading-tight uppercase text-gray-900 font-futuristic">
                ...
                <button 
                  onClick={() => document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' })}
                  className="inline-flex items-center font-semibold text-sm sm:text-base group uppercase tracking-wide hover:opacity-80 font-tech transition-colors min-h-[44px]"
                  style={{ color: '#FF6B35' }}
                >
                  Demander un devis
                  <ArrowRight className="ml-2 w-4 h-4 sm:w-5 sm:h-5" />
        ...
        <div className="section py-4 sm:py-6 lg:py-8 slide-in-left relative z-20 diagonal-cut-top-backslash diagonal-cut-bottom-slash" style={{ background: 'linear-gradient(135deg, #0A0A0A 0%, #1A1A1A 100%)' }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
              <div>
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg flex items-center justify-center mb-3 sm:mb-4" style={{ background: '#FF6B35', color: 'white' }}>
        ...
        <div className="section py-4 sm:py-6 lg:py-8 slide-in-right diagonal-cut-top-slash" style={{ background: 'linear-gradient(135deg, #F8F9FA 0%, #FFFFFF 100%)' }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
              <div className="lg:order-2">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg flex items-center justify-center text-white mb-3 sm:mb-4" style={{ background: '#FF6B35' }}>
