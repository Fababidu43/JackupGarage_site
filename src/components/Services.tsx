  ...
  return (
    <section id="services" className="relative">
      ...
      <div className="section py-12 lg:py-16" style={{ background: '#F8F9FA' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center scroll-animate">
          ...
          <p className="text-lg font-semibold uppercase font-tech scroll-animate-fade delay-300" style={{ color: '#FF6B35' }}>
