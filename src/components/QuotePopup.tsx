...
Merci de me recontacter pour un devis !`;
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-2 sm:p-4 overflow-y-auto">
      ...
      <div className="relative bg-gradient-to-br from-gray-900 via-black to-gray-900 rounded-2xl shadow-2xl w-full max-w-sm sm:max-w-md lg:max-w-lg my-4 sm:my-8 border border-orange-500/30 max-h-[calc(100vh-2rem)] sm:max-h-[calc(100vh-4rem)] overflow-y-auto">
        {/* Accent lumineux */}
        ...
        <div className="relative flex items-center justify-between p-3 sm:p-4 lg:p-6 border-b border-orange-500/20">
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 bg-white/95 border border-orange-500/30 rounded-xl flex items-center justify-center shadow-lg p-1.5 sm:p-2 lg:p-3">
              <img 
                src="/src/logo.png" 
                alt="Jack Up Garage" 
