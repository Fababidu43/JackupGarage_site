...
const ServiceArea = () => {
  ...
  return (
    <section 
      id="area" 
      className="section relative text-white overflow-hidden dynamic-bg reveal-on-scroll py-8 lg:py-12"
      style={{ background: 'linear-gradient(to bottom, #0A0A0A 0%, #1A1A1A 100%)' }}
    >
      {/* Effet de mouvement subtil */}
      <div className="absolute inset-0 opacity-30">
        <div className="tech-grid-animated h-full w-full"></div>
      </div>
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-6 sm:mb-8">
          <h2 className="text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-black text-white mb-4 sm:mb-6 tracking-tight uppercase font-futuristic text-glow">
            Zone d'intervention
          </h2>
          <div className="max-w-4xl mx-auto bg-orange-500/10 border border-orange-500/20 rounded-lg p-4 sm:p-6 mb-6 sm:mb-8 hover-scale">
