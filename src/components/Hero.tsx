  ...
  return (
    ...
    >
      ...
      <video
        ...
        preload="none"
        poster="/a_propos.JPG"
        title="JACK Up Auto - Jack Up Auto - Présentation du service garage automobile mobile"
        aria-label="Vidéo de présentation Jack Up Auto - Garage mobile Haute-Loire Loire"
        onError={(e) => {
      ...
      >
        <meta itemProp="name" content="JACK Up Auto - Jack Up Auto - Présentation du service garage automobile mobile" />
        <meta itemProp="description" content="Découvrez Jack Up Auto, votre garage automobile mobile en Haute-Loire (43) et Loire (42)" />
      ...
      <div className="hero-content relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto pt-16 w-full transition-all duration-1000 ease-out">
        ...
        <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-white/80 font-light mb-6 sm:mb-8 tracking-wide font-tech reveal-on-scroll px-2 max-w-3xl mx-auto animate-fade-in-delayed">
          ...
          <span className="text-white font-bold bg-orange-500/80 px-4 py-2 rounded-lg border-2 border-orange-300 shadow-2xl backdrop-blur-sm animate-text-shimmer inline-block mt-2 glow-effect-permanent">
            N'allez plus au garage, faites venir le garage !
          </span>
        </p>
