    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="text-center mb-12 scroll-animate">
          ...
          <div className="max-w-4xl mx-auto bg-orange-500/10 border border-orange-500/20 rounded-lg p-6 mb-8 hover-scale border-glow scroll-animate-scale delay-200">
          ...
          {/* Badge Saint-Étienne */}
          <div className="inline-flex items-center bg-yellow-500/20 border border-yellow-500/30 rounded-full px-4 py-2 mb-6 pulse-subtle scroll-animate-fade delay-400">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-12">
          {/* Haute-Loire */}
          <div className="bg-orange-500/10 backdrop-blur-sm p-6 rounded-lg border border-orange-500/20 hover-scale border-glow scroll-animate-left">
          ...
          {/* Loire */}
          <div className="bg-orange-500/10 backdrop-blur-sm p-6 rounded-lg border border-orange-500/20 hover-scale border-glow scroll-animate-right delay-200">
            <div className="flex items-center mb-4">
              <div className="w-10 h-10 bg-orange-500 rounded-lg flex items-center justify-center text-white mr-3 pulse-subtle">
                <MapPin className="w-5 h-5" />
              </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white p-6 rounded-lg shadow-lg border border-orange-500/20 hover-scale border-glow scroll-animate-scale delay-300">
