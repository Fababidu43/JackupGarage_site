  ...
  return (
    <div className="min-h-screen pb-16 md:pb-0">
      ...
      <main>
        ...
        <DiagonalSlash topColor="#FFFFFF" bottomColor="#E67E22" type="section" />
        
        {/* Services intro (orange #E67E22) */}
        <Services />
        
        {/* Services → Service 1 : diagonale "\" */}
        <DiagonalBackslash topColor="#E67E22" bottomColor="#FFFFFF" type="service" />
        
        {/* Service 1 - Blanc #FFFFFF */}
        <div className="section section--entretien py-8 lg:py-12" style={{ background: '#FFFFFF' }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div>
                <div className="w-12 h-12 rounded-lg flex items-center justify-center mb-4 text-white" style={{ background: '#E67E22' }}>
        ...
        <DiagonalSlash topColor="#FFFFFF" bottomColor="#E67E22" type="service" />
        
        {/* Service 2 - Orange #E67E22 */}
        <div className="section py-8 lg:py-12" style={{ background: '#E67E22' }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="lg:order-2">
                <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center mb-4" style={{ color: '#E67E22' }}>
        ...
        <div className="section py-8 lg:py-12" style={{ background: '#FFFFFF' }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div>
                <div className="aspect-square w-full max-w-xs mx-auto rounded-lg shadow-lg flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #E67E22, #D35400)' }}>
                  <div className="text-white text-4xl opacity-20">
        ...
        <DiagonalSlash topColor="#FFFFFF" bottomColor="#F6F6F6" type="service" />
        ...
        <div className="section py-8 lg:py-12" style={{ background: '#F6F6F6' }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="lg:order-2">
                <div className="w-12 h-12 rounded-lg flex items-center justify-center text-white mb-4" style={{ background: '#E67E22' }}>
        ...
        <DiagonalSlash topColor="#F6F6F6" bottomColor="#F6F6F6" type="section" />
