  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <div className="section section--entretien py-4 sm:py-6 lg:py-8 dynamic-bg-dark slide-in-left" style={{ background: '#0A0A0A' }}>
        ...
        <div className="section py-4 sm:py-6 lg:py-8 dynamic-bg-service slide-in-right" style={{ background: '#F8F9FA' }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
        ...
        <div className="section py-4 sm:py-6 lg:py-8 dynamic-bg-dark slide-in-left relative z-20" style={{ background: '#0A0A0A' }}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
              <div>
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg flex items-center justify-center mb-3 sm:mb-4 hover-scale pulse-subtle subtle-glow animated-border" style={{ background: '#FF6B35', color: 'white' }}>
