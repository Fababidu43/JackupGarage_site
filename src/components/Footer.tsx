        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-4">
              <div className="w-20 h-16 rounded-lg flex items-center justify-center glow-hover bg-gradient-to-br from-orange-500/10 to-orange-600/5 border border-orange-500/20">
                <img 
                  src="/src/logo.png" 
                  alt="Jack Up Garage" 
                  className="h-12 w-auto max-w-none drop-shadow-xl filter brightness-125 hover:brightness-150 transition-all duration-300"
                />
              </div>
              <div>
